...
const AFFILIATE_URL = 'https://trksy.org/aff_c?offer_id=1323&aff_id=144760';

const COSTCO_CARDS = [
  {
    icon: Home,
    title: 'Wholesale Home & Appliances',
    description:
      'Major appliances, patio sets, mattress deals, kitchen gadgets, and home organization.',
  },
  {
    icon: Tv,
    title: 'Electronics & Computers',
    description:
      'OLED Smart TVs, laptops, tablets, soundbars, security systems, and smart watches.',
  },
  {
    icon: Sparkles,
    title: 'Kirkland Signature & Health',
    description:
      'Kirkland Signature products, vitamins, premium skincare, pharmacy, and optical deals.',
  },
  {
    icon: ShoppingBag,
    title: 'Bulk Groceries & Apparel',
    description:
      'Member-only bulk pantry items, designer apparel, footwear, and seasonal outdoor gear.',
  },
];
...
export default function App() {
  ...
  return (
    <div className="w-full min-h-screen bg-[#fcfcfc] text-slate-900 font-['Plus_Jakarta_Sans',sans-serif] antialiased selection:bg-[#005DAA] selection:text-white">
      {/* ================= HERO SECTION ================= */}
      <section className="relative overflow-hidden bg-gradient-to-b from-[#003B70] via-[#002D5B] to-[#001D3D] text-white pt-12 pb-16 sm:pt-20 sm:pb-28 px-4 sm:px-6">
        {/* Softer, subtle ambient glow */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-4xl h-80 bg-blue-400/15 blur-[130px] pointer-events-none rounded-full" />
        ...
        <div className="relative max-w-2xl sm:max-w-4xl mx-auto text-center flex flex-col items-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-black/20 border border-white/20 text-xs sm:text-sm text-blue-100 font-semibold mb-8 shadow-inner backdrop-blur-sm">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-tight text-white leading-[1.15] mb-6 max-w-3xl">
            The <span className="text-[#fde047]">Costco Discounts</span> They Don't Advertise
          </h1>

          {/* Subtitle */}
          <p className="text-base sm:text-lg text-blue-100/90 font-normal max-w-xl mx-auto mb-9 leading-relaxed px-1">
            Discover how shoppers are unlocking hidden discount codes on bulk groceries, electronics, Kirkland Signature items, home appliances, and member deals.
          </p>
          ...
          <a
            ...
            id="hero-apply-btn"
            className="inline-flex items-center justify-center gap-2.5 bg-white text-[#003B70] hover:bg-blue-50 active:scale-95 font-bold text-lg px-9 py-4 rounded-full shadow-xl transition-all duration-200 cursor-pointer mb-8"
          >
            <span>Apply Now</span>
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 bg-white text-slate-900">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-12 sm:mb-16">
            <span className="text-xs sm:text-sm font-bold tracking-widest text-[#005DAA] uppercase block mb-2">
              HOW IT WORKS
            </span>
          ...
          <div className="relative">
            ...
            <div className="absolute left-4 md:left-1/2 top-6 bottom-10 -translate-x-1/2 w-0.5 bg-[#005DAA]/80" />

            <div className="space-y-10 sm:space-y-12">
              {/* STEP 1 */}
              <div className="relative flex flex-col md:grid md:grid-cols-2 md:gap-12 items-center">
                {/* Center Badge */}
                <div className="absolute left-4 md:left-1/2 -translate-x-1/2 w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-[#005DAA] text-white font-bold text-xs sm:text-sm flex items-center justify-center shadow-md z-10 shrink-0">
                  1
                </div>
                ...
                <div className="pl-12 md:pl-0 w-full flex justify-end">
                  <div className="w-full max-w-md bg-white border border-slate-200/90 rounded-2xl p-4 sm:p-5 shadow-sm hover:shadow-md transition-shadow flex items-center justify-between gap-4">
                    ...
                    <div className="shrink-0 p-3 rounded-xl bg-blue-50/80 border border-blue-100 text-[#005DAA]">
          ...
          <div className="mt-14 sm:mt-18 text-center">
            <a
              href={AFFILIATE_URL}
              onClick={handleApplyClick}
              className="inline-flex items-center justify-center gap-2.5 bg-[#005DAA] hover:bg-[#004A88] text-white active:scale-95 font-bold text-lg px-9 py-4 rounded-full shadow-md transition-all duration-200 cursor-pointer"
            >
              <span>Apply Now</span>
              <ArrowRight className="w-5 h-5 stroke-[2.5]" />
            </a>
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 bg-[#fafafa] text-slate-900 border-t border-slate-200/60">
        <div className="max-w-xl sm:max-w-3xl mx-auto">
          {/* Eyebrow & Title */}
          <div className="text-center mb-12 sm:mb-16">
            <span className="text-xs sm:text-sm font-bold tracking-widest text-[#005DAA] uppercase block mb-3">
              UNLOCK REWARDS
            </span>
            ...
            {COSTCO_CARDS.map((card, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="p-3 rounded-xl shrink-0 bg-blue-50/80 border border-blue-100 text-[#005DAA]">
      ...
      {/* ================= FOOTER CTA SECTION ================= */}
      <section className="relative overflow-hidden bg-gradient-to-b from-[#003B70] via-[#002D5B] to-[#001D3D] text-white py-16 sm:py-24 px-4 sm:px-6 text-center">
        {/* Background ambient lighting */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-3xl h-64 bg-blue-400/15 blur-[130px] pointer-events-none rounded-full" />
        ...
        <div className="relative max-w-2xl mx-auto flex flex-col items-center">
          ...
          {/* Subtitle */}
          <p className="text-base sm:text-lg text-blue-100/90 font-normal max-w-md sm:max-w-xl mx-auto mb-9 leading-relaxed px-2">
            Join thousands of shoppers who have already claimed their Costco discount code. Your next deal is just a few clicks away.
          </p>
          ...
          <a
            href={AFFILIATE_URL}
            onClick={handleApplyClick}
            className="inline-flex items-center justify-center gap-3 bg-white text-[#003B70] hover:bg-blue-50 active:scale-95 font-bold text-lg px-9 py-4 rounded-full shadow-xl transition-all duration-200 cursor-pointer"
          >
            <span>Apply Now</span>
            <ArrowRight className="w-5 h-5 stroke-[2.5]" />
          </a>
            ...
            {modalStep === 1 ? (
              <form onSubmit={handleModalSubmit} className="space-y-4 text-left">
                <div className="text-center mb-3">
                  <div className="w-11 h-11 rounded-full bg-blue-50 text-[#005DAA] flex items-center justify-center mx-auto mb-2">
                    <ShoppingBag className="w-5 h-5" />
                  </div>
                  <h3 className="text-lg font-extrabold text-slate-900">
                    Costco Reward Portal
                  </h3>
                ...
                <button
                  type="submit"
                  className="w-full py-3 bg-[#005DAA] hover:bg-[#004A88] text-white font-bold rounded-xl shadow-md transition-all cursor-pointer text-xs flex items-center justify-center gap-2"
                >
                  <span>Apply Now</span>
              ...
              <div className="py-3 space-y-3">
                <div className="w-11 h-11 rounded-full bg-blue-50 text-[#005DAA] flex items-center justify-center mx-auto">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  We've emailed your Costco discount confirmation link to{' '}
                  <strong>{email}</strong>. Check your inbox to complete the 30-second verification.
                </p>
                <button
                  onClick={closeModal}
                  className="w-full py-2.5 bg-[#005DAA] hover:bg-[#004A88] text-white font-bold rounded-xl text-xs cursor-pointer"
                >
                  Done
                </button>
              </div>
